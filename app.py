...
.stApp {
    background:
        ...
        radial-gradient(circle at 90% 20%, rgba(168,85,247,0.14), transparent 30%),
...
<div class="info-card">
    ...
    <div class="info-text">
        ...
        وسيقوم النظام بتحليلها باستخدام
        تقنيات تعلم الآلة لتحديد ما إذا كانت
        آمنة أو مشبوهة.
    </div>
...
# استخدام session_state لجعل زر المسح يعمل فعلياً
...
with st.expander("ℹ️ معلومات عن النظام"):
    ...
    **عدد رسائل التدريب:**
    ...
    st.info(f"📚 {len(texts)} رسالة تدريب")
